class ShortenedUrlsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @shortened_url.update(shortened_url_params)
        format.html { redirect_to shortened_url_url(@shortened_url), notice: "Shortened url was successfully updated." }
  ...
  private
    ...
    def shortened_url_params
      params.require(:shortened_url).permit(:original_url, :short_url, :title, :redirects)
    end
end
